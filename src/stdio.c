...
int vsprintf(char *buf, const char *fmt, va_list args) {
    ...
    while (*fmt) {
        ...
        while (1) {
            switch (*fmt) {
                case '-': left_align = 1; fmt++; continue;
                case '+': show_sign = 1; fmt++; continue;
                case ' ': space_if_no_sign = 1; fmt++; continue;
                case '#': alternate_form = 1; fmt++; continue;
                case '0': zero_pad = 1; fmt++; continue;
            }
            break;
        }
        ...
        switch (*fmt) {
            ...
            case 'i': {
                ...
                char negative = num < 0;
                unsigned long unum = negative ? -num : num;
